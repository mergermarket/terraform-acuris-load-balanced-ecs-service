# terraform-acuris-load-balanced-ecs-service

[![Build Status](https://travis-ci.org/mergermarket/terraform-acuris-load-balanced-ecs-service.svg?branch=master)](https://travis-ci.org/mergermarket/terraform-acuris-load-balanced-ecs-service)
